...
{
if ((pplr->isInCombat()) || (pplr->isInFlight()) || (pplr->isDead()))
{
pplr->SendEquipError(EQUIP_ERR_NOT_IN_COMBAT, pItem, NULL);
return false;
}
if (pplr->IsMounted()) // Is player mounted
{
pplr->SendEquipError(EQUIP_ERR_CANT_DO_RIGHT_NOW, pItem, NULL);
return true;
}
{
pplr->RemoveAllSpellCooldown();
return true;
}
}*/
